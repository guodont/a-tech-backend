...
public class Global extends GlobalSettings {
    ...
    private class ActionWrapper extends Action.Simple {
        ...
        public Promise<Result> call(Http.Context ctx) throws java.lang.Throwable {
            ...
            response.setHeader("Access-Control-Allow-Headers", "X-Requested-With,Content-Type,Accept,X-AUTH-TOKEN,VERIFY_UUID,WECHAT-AUTH-TOKEN");
            return result;
        }
    }
    ...
    */
    ...
    private static class CORSResult implements Result {
        ...
        public CORSResult(Status status) {
            ...
            Tuple2<String, String> t2 = new Tuple2<String, String>("Access-Control-Allow-Headers","X-Requested-With,Content-Type,Accept,X-AUTH-TOKEN,VERIFY_UUID,WECHAT-AUTH-TOKEN");
            list.add(t);
            list.add(t2);
