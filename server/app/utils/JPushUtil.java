...
public class JPushUtil {
    ...
    public JPushUtil(String title, String alert, String msgContent, String tag, String registrationId) {
        this.title = title;
        this.alert = alert;
    ...
    public JPushUtil(String alert, String msgContent, String title) {
        this.alert = alert;
        this.msgContent = msgContent;
        this.title = title;
    }

    public JPushUtil(String title, String alert, String msgContent, String tag) {
        this.title = title;
        this.alert = alert;
        this.msgContent = msgContent;
        this.tag = tag;
